...
import { MdAccessTime, MdCheck, MdMessage, MdDelete, MdBlock, MdDoneAll, MdContentCopy } from 'react-icons/md'
...
const MessageBox: React.FC<MessageBoxType> = ({ focus = false, notch = true, ...props }) => {
  ...
  return (
    <>
      {popupData ?
        <div className='ctp-model-main-wrapper'>
          <div className="ctp-model-main-wrapper-inner">
            <div className="ctp-model-file-wrapper">
              <div className="ctp-model-close-icon" onClick={() => onClickCloseIcon()}>
                <RiCloseLine />
              </div>
              <div className="rpu-model-save-as-icon">
                <TbMessages />
              </div>
              <div className="ctp-dispaly-folder-ui-wrapper amm-dispaly-folder-ui-wrapper">
                <div className="ctp-folder-name" onClick={props.onReplyClick}>
                  <div className="stp-folder-name-right" >
                    <span className='stp-folder-name-icon stp-folder-name-icon1'>
                      <BsReply />
                    </span>
                    Reply To
                  </div>
                </div>
                <div className="ctp-folder-name">
                  <div className="stp-folder-name-right"
                   onClick={props.onForwardClick}
                   >
                    <span className='stp-folder-name-icon'>
                      <MdContentCopy />
                    </span>
                    Copy To
                  </div>
